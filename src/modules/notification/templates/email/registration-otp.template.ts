...
export const getRegistrationOtpEmailTemplate = (otp: string) => {
  const subject = 'Welcome to Candle Shop! Verify your email';
  const text = `Welcome to Candle Shop! Use the verification code below to complete your registration. Code: ${otp}. This code is valid for ${OTP_EXPIRY_MINUTES} minutes. Do not share this code with anyone.`;
  const html = `
<!DOCTYPE html>
<html lang="en">
<head>
          ...
          <tr>
            <td style="padding:40px;">
              ...
              <p style="margin:0 0 24px;color:#4a3728;font-size:16px;line-height:1.6;">
                We're excited to have you join our community of candle lovers.
