...
export const getForgotPasswordOtpEmailTemplate = (otp: string) => {
  const subject = 'Reset your Candle Shop Password';
  const text = `We received a request to reset your password. Use the verification code below to authorize this request. Code: ${otp}. This code is valid for ${OTP_EXPIRY_MINUTES} minutes. Do not share this code with anyone.`;
  const html = `
<!DOCTYPE html>
<html lang="en">
<head>
          ...
          <tr>
            <td style="padding:40px;">
              ...
              <p style="margin:0 0 24px;color:#4a3728;font-size:16px;line-height:1.6;">
                ...
                Use the verification code below to authorize this request.
