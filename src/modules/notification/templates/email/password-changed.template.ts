export const getPasswordChangedEmailTemplate = () => {
  const subject = 'Your Candle Shop Password Was Changed';
  const text = `Hello, this is a confirmation that your Candle Shop password has been changed successfully. If you did not make this change, please contact our support team immediately.`;
  const html = `
<!DOCTYPE html>
<html lang="en">
<head>
          ...
          <tr>
            <td style="padding:40px;">
              ...
              <p style="margin:0 0 24px;color:#4a3728;font-size:16px;line-height:1.6;">
                This email confirms that the password for your Candle Shop account has been <strong>successfully changed</strong>.
              </p>
                  ...
                  <td align="center">
                    <div style="display:inline-block;background:#fdfaf7;border:1px solid #e8dec9;
                      ...
                      <span style="font-size:14px;color:#7a6a5e;">
                        Your account password was updated. No further action is required if this was you.
                      </span>
                    </div>
                  </td>
                </tr>
              ...
              <p style="margin:0 0 8px;color:#7a6a5e;font-size:14px;line-height:1.6;">
                ⚠️ <strong>Did you not make this change?</strong>
              </p>
